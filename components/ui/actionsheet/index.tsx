...
import { FlatList, Pressable, PressableProps, ScrollView, SectionList, Text, View, ViewStyle, VirtualizedList } from 'react-native';
...
const ActionsheetContent = React.forwardRef<React.ComponentRef<typeof UIActionsheet.Content>, IActionsheetContentProps>(
